    ...
    <button type="submit" name="submit-search" class="search-btn"><i class="fa fa-search" style="color:white"></i></button>
        ...
        <div class="sort">
            ...
            <div class="dropdown2">
                ...
                <div id="myDropdown" class="dropdown-content">
                    <a href="filteredloc_stay.php?region=Mumbai">Mumbai</a>
                    <a href="filteredloc_stay.php?region=Navi Mumbai">Navi Mumbai</a>
                    <a href="filteredloc_stay.php?region=Thane">Thane</a>
                </div>
                </div>
        </form><br><br>
        <div class="box-container">
            <?php 
               ...
               $query = "SELECT * FROM hotels ORDER BY rating DESC LIMIT 25";
