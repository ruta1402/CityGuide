...
<body>
    ...
    <section class="packages">
        ...
        <h1 class="heading-title">Stay</h1>
        <form action="searchedhotels.php" method="POST">
    ...
    <button type="submit" name="submit-search" class="search-btn"><i class="fa fa-search" style="color:white"></i></button>
        ...
        <form>
        <div class="sort">
            <button class="dropbtn2">Sort By Rating</button>
                <div id="myDropdown" class="dropdown-content">
                    <a href="filteredhtl_stay.php">High to Low</a>
                    <a href="filteredlth_stay.php">Low to High</a>
                </div>
            </div>
            <div class="dropdown2">
                <button class="dropbtn">Filter</button>
                <div id="myDropdown" class="dropdown-content">
                    <a href="filteredloc_stay.php?address=Mumbai">Mumbai</a>
                    <a href="filteredloc_stay.php?address=Navi Mumbai">Navi Mumbai</a>
                    <a href="filteredloc_stay.php?address=Thane">Thane</a>
                </div>
                </div>
        </form><br><br>
        <div class="box-container">
            ...
            $query = "SELECT * FROM hotels WHERE name LIKE '%$search%' OR region LIKE '%$search%' OR address LIKE '%$search%'";
                        ...
                        echo"
                                 <div class='box'>
                                    ...
                                    <div class='content'>
                                       ...
                                       <p>".$rows['rating']." &nbspStar Rating</p>
                                       <p>".$rows['region']."</p>
                                       <p>".$rows['address']."</p>
                                    </div>
                                 </div>
