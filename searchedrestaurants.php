    ...
    <button type="submit" name="submit-search" class="search-btn"><i class="fa fa-search" style="color:white"></i></button>
        ...
        <div class="box-container">
            <?php 
               ...
               $query = "SELECT * FROM restaurants WHERE name LIKE '%$search%' OR region LIKE '%$search%' OR type LIKE'%$search%' OR cusine LIKE '%$search%' LIMIT 25";
                                    ...
                                    <div class='content'>
                                       ...
                                       <div class='star-widget'>
                                        <form action='action.php?' method='POST''>
                                            ...
                                            <label for='rate-5' value='4' class='fas fa-star'></label>
