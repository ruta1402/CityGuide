...
<body>
    ...
    <section class="booking">
        ...
        <h1 class="heading-title">let everyone know about the unique place that you discovered</h1>

        <form action="addplace_.php" method="post" class="book-form" enctype="multipart/form-data">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" placeholder="describe the place" name="description">
                </div>
                <div class="inputBox">
                    <span>address :</span>
