...
<body>
    ...
    <section class="booking">
        ...
        <h1 class="heading-title">tell us your interests</h1>

        <form action="recommend_.php" method="post" class="book-form">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    <span>favourite type of restaurant(eg:cafe,fine dining,...) :</span>
                    <input type="text" placeholder="enter restaurant type" name="resttype" required>
    
                </div>
            </div>

            <input type="submit" value="recommend" class="btn" name="recommend">
            <br><br>
